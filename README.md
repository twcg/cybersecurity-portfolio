...
|---------|---------------|--------|----------|
| Disable root SSH login | 5.2.8 | ✅ **Implemented** | [View Code](../02-automated-implementation/ansible/roles/ssh-hardening/templates/sshd_config.j2#L8) |
| Disable password authentication | 5.2.3 | ✅ **Implemented** | [View Code](../02-automated-implementation/ansible/roles/ssh-hardening/templates/sshd_config.j2#L9) |
| Configure SSH Protocol | 5.2.2 | ✅ **Implemented** | [View Code](../02-automated-implementation/ansible/roles/ssh-hardening/templates/sshd_config.j2#L5) |
| Set MaxAuthTries | 5.2.5 | ✅ **Implemented** | [View Code](../02-automated-implementation/ansible/roles/ssh-hardening/templates/sshd_config.j2#L6) |
| Configure ClientAlive intervals | 5.2.12 | ✅ **Implemented** | [View Code](../02-automated-implementation/ansible/roles/ssh-hardening/templates/sshd_config.j2#L7) |
